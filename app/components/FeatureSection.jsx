export default function FeatureSection() {
  return (
    <div className="bg-[#171413] min-h-screen py-26 mt-26 mb-0 px-1">
      {/* Header */}
      <div className="max-w-2xl mx-auto text-center mb-12">
        <h1 className="text-3xl font-bold text-white">
          Best <span className="text-red-500">AI</span> Note taking{" "}
          <span className="text-red-500">Assistant</span>
        </h1>
        <p className="text-gray-400 mt-3 text-lg">
          Explore features designed to make your notes smarter and more
          organized.
        </p>
      </div>
      {/* Cards */}
      <div className="flex flex-col flex-wrap md:flex-row gap-8 max-w-7xl mx-auto">
        ...
        <div className="bg-[#23201F] rounded-2xl p-8 flex-1 flex flex-col gap-7 justify-between shadow-xl min-w-full sm:min-w-[320px]">
          <h2 className="text-white text-2xl font-bold mb-2">
            Record, Upload or Write
          </h2>
        ...
        <div className="bg-[#23201F] rounded-2xl p-8 flex-1 flex flex-col justify-between shadow-xl min-w-full sm:min-w-[320px] items-center relative">
          ...
          <div className="w-full max-w-[14rem] h-40 sm:h-48 relative flex justify-center items-center mb-2">
            <img
              src="/image2.png"
              alt="Book"
        ...
        <div className="bg-[#23201F] rounded-2xl p-8 flex-1 flex flex-col justify-between shadow-xl min-w-full sm:min-w-[320px] items-center">
          <h2 className="text-white text-2xl font-bold mb-2">YouTube Videos</h2>
          <p className="text-gray-400 text-base mb-8 text-center">
            Turn YouTube videos into summaries, lecture notes and much more
            directly from a link
          </p>
          <div className="w-full flex flex-col gap-4 items-center">
            <div className="w-full max-w-[19rem] h-40 sm:h-48 relative flex justify-center items-center mb-2">
              <img
                src="/image3.png"
                alt="Book"
        ...
        <div className="bg-[#23201F] rounded-2xl p-8 flex-1 flex flex-col justify-between shadow-xl min-w-full sm:min-w-[320px] items-center">
          ...
          <p className="text-gray-400 text-base mb-8 text-center">
            Get high quality transcripts and translations for all your
            recordings, files and videos
          </p>
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-md p-4">
            ...
            <div className="text-xs text-gray-500 mb-2">
              Sept 16, 2024 · 10:00 AM
            </div>
            <div className="flex items-center gap-2 mb-2">
              <button className="bg-black rounded-full w-7 h-7 flex items-center justify-center text-white">
                ▶️
              </button>
              <span className="text-gray-700 text-sm">3:00 / 8:00</span>
            </div>
            <div className="flex gap-2 mb-2">
              <button className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full">
                All Notes
              </button>
              <button className="text-xs bg-gray-200 text-black px-2 py-1 rounded-full font-bold">
                Transcript
              </button>
              <button className="text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full">
                Speaker Distinction
            ...
            <div className="bg-white rounded-xl p-2 mt-2 text-gray-800 text-xs">
              <b>Transcript</b>
              <br />
              Welcome, everyone. Today, we'll cover our Q4 strategy and align on
        ...
        <div className="bg-[#23201F] rounded-2xl p-8 flex flex-col items-center shadow-xl min-w-full sm:min-w-[320px] max-w-md mx-auto">
          <h2 className="text-white text-2xl font-bold mb-2 text-left w-full">
            Summarize
          </h2>
          ...
          <div className="relative w-full max-w-sm flex flex-col items-center">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 w-full flex flex-col justify-start items-start">
              ...
              <div className="flex items-center gap-2 mb-3">
                <button className="bg-black rounded-full w-8 h-8 flex items-center justify-center text-white text-lg">
                  ▶️
                </button>
              ...
              <div className="flex gap-2 mb-2">
                <button className="text-xs bg-gray-100 text-gray-700 px-4 py-2 rounded-full">
                  All Notes
                </button>
                <button className="text-xs bg-gray-200 text-black px-4 py-2 rounded-full font-bold">
                  Transcript
                </button>
                <button className="text-xs bg-gray-100 text-gray-700 px-4 py-2 rounded-full">
                  Speaker Distinction
            ...
            <div
              className="absolute left-1/2 -translate-x-1/2 -bottom-8 max-w-xs bg-white rounded-t-2xl shadow-2xl py-5 px-6"
              style={{ boxShadow: "0 8px 24px rgba(0,0,0,0.18)" }}
            >
              <div className="text-black text-[16px] font-bold mb-2">
                Summary
              </div>
