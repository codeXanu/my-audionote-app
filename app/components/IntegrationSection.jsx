...
const IntegrationCard = ({ icon, name, description }) => (
  <div className="flex flex-col items-center p-8 bg-white border border-gray-200  rounded-xl transition-shadow duration-300 hover:shadow-lg w-full max-w-xl sm:w-[48%] lg:w-[25%]">
    ...
    <button className="mt-auto w-full py-2 px-4 bg-gray-800 text-white font-medium rounded-full hover:bg-gray-900 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50">
      + Connect
    </button>
  </div>
);
