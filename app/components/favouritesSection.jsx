...
export default function FavouritesSection({ cardsData, setSelectedCard, setIsDailougeOpen, onToggleFavourite }) {
  ...
  if (favouriteCards.length === 0) {
    return (
      ...
      <div className="flex flex-col items-center p-8 text-center rounded-xl">
        ...
        {/* Title */}
        <h3 className="text-xl font-semibold text-gray-700 mb-2">No favourites found yet</h3>

        {/* Description */}
        <p className="text-sm text-gray-500 mb-6">Add notes to favourite to see them here</p>
  ...
  return (
    <div>
        ...
        <h1 className="text-3xl font-medium text-gray-700 mb-4" > Your Favourites </h1>
