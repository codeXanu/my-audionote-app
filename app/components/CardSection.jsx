  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 max-w-6xl mx-auto">
            <div className="p-4 md:w-1/3">
                <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                <div className="flex items-center mb-3">
                    <div className="w-14 h-14 mr-3 inline-flex items-center justify-center rounded-full text-red flex-shrink-0">
                    <IoPersonSharp className="text-red-500 w-3xl h-10 " />
                    <IoPersonSharp className="text-red-500 w-3xl h-10" />
                    </div>
                </div>
                <div className="flex-grow">
                    <h1 className="text-black text-xl title-font font-bold mb-2.5">
                    Meetings
                    </h1>
            ...
            <div className="p-4 md:w-1/3">
                <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                <div className="flex items-center mb-3">
                    <div className="w-10 h-10 mr-3 inline-flex items-center justify-center rounded-full text-red flex-shrink-0">
