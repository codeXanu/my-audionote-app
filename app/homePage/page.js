...
import { Home, Star, Zap, Folder, User } from "lucide-react";
            ...
            <nav className="flex flex-col flex-1 p-4 gap-1 mt-5">
                ...
                <div className={ `${isOpen ? "bg-white" : " bg-red-50"} p-4 rounded-4xl border border-gray-300 shadow-sm font-sans m-4`} >
                    ...
                    <>
                        ...
                        <a href="#" class="flex items-center justify-between p-3 rounded-4xl bg-red-100 text-red-600 font-medium transition-colors hover:bg-red-200">
      ...
      {/* Main Content */}
        <div className="flex-1  p-6 overflow-y-auto relative">
            ...
            <div className="flex flex-wrap justify-center gap-6">
                ...
                {/* Input box */}
                    {/* <InputBox />
            <div className="fixed bottom-0 flex justify-center  w-full bg-amber-200 " >
                <div className="w-full max-w-2xl px-4 bg-amber-700">
                </div>
...
//     <div className="p-4 bg-white rounded-4xl shadow-lg border border-gray-200 mb-4">
